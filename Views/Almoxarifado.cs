...
namespace Views {
    ...
    public class Almoxarifados {
        ...
        public static void ListarAlmox() {
            ...
            btnSalvar.Click += (sender, e) => {
                ...
                {
                    MessageBox.Show($"Erro ao adicionar almoxarifado: {err.Message}");
                }
                finally 
                {
                    adicionarAlmox.Hide();
        ...
        public static void EditarAlmox(int id) {
            Models.Almoxarifado almoxarifado = Controllers.Almoxarifado.BuscaAlmoxarifado(id);
            Form editar = new Form();
            editar.Text = "Editar Almoxarifado";
            editar.Size = new System.Drawing.Size(235, 163);
            ...
            txtId.Left = 110;
            txtId.Size = new System.Drawing.Size(100, 25);
            txtId.Text = almoxarifado.id.ToString();
            txtId.ReadOnly = true;
            ...
            txtNome.Left = 110;
            txtNome.Size = new System.Drawing.Size(100, 25);
            txtNome.Text = almoxarifado.nome;
